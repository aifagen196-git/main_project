// job-engine/vendor/prompts.js
//
// SYNCED COPY of backend/src/prompts/prompts.js (aifagen main repo) — see
// job-engine/vendor/scoreMatch.js's header for why this file exists here at
// all (job-engine used to import it via a relative "../../backend/..." path
// that broke once job-engine became its own repo). NOT auto-synced; re-copy
// manually if the backend's prompt changes.
//
