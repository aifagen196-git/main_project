// job-engine/vendor/scoreMatch.js
//
// SYNCED COPY of backend/src/services/matching/scoreMatch.js (aifagen main
// repo). job-engine used to import this directly via a relative
// "../../backend/..." path when it lived as a subdirectory of that repo —
// broke with an ERR_MODULE_NOT_FOUND once job-engine was split into its own
// repo (github.com/aifagen196-git/collectors), since backend/ isn't there.
// Copied in rather than published as a shared package, since only
// inferRoleFamily is actually used here (collectors/lib/isDomainJob.js,
// collectors/backfillRoleFamilyHeuristic.js).
//
// If the backend's scoring logic changes, re-copy this file manually — it
// is NOT auto-synced.
//
